...
class InformController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $check_attendance = Attendance::whereBetween('check_in_time',[$attendance_date ,$limit_date])->where('user_id',$request->employee)->first();
        ...
        if (!(empty($check_attendance))){
            ...
            $late_inform =$compare_time->greaterThanOrEqualTo($default_time);
                ...
                $check_attendance->attendance_type  ='informed';

...
class RequestLeaveController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $data= view('layouts.modal-view',compact('request_leave'))->render();
    ...
    public function update(Request $request, $id)
    {
        ...
        $user = $request_leave->get_user;
        if ($request_leave->to_date != null ) {
...
//        $get_diff=$this->generateDateRange($request_from_date,$request_to_date);
        ...
        if (isset($get_leave_dates)) {
    ...
    }elseif ($request_leave->to_date == null ){
            ...
            $inform = Inform::create([
                'attendance_date' => Carbon::parse($request_leave->to_date)->startOfDay()->timestamp,
                'inform_at' => Carbon::parse($request_leave->created_at)->timestamp,
                'user_id' => $user->id,
                'inform_type' => 'leave',
                'reason' => $request_leave->reason,

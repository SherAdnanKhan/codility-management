...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'address', 'qualification','designation', 'phoneNumber', 'opening_balance','joiningDate', 'checkInTime', 'checkOutTime', 'breakAllowed', 'workingDays','abendend'
    ];

...
<br>
<br>
@php        $question=$item->qNA()->where('category_id',$item->id)->get();
...
<span style="">Q# {{$print_question->id}} &nbsp; &nbsp;</span>{{$print_question->question}} <p style="margin-left: 90%; margin-top: -20px"> ({{$print_question->marks}}) </p>
